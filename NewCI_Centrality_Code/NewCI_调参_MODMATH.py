...
def New_Collective_Influence(G):
    ...
    for nid in G_Balance.keys():
        ...
        newCI[nid]=round(float((0.9*G_Balance[nid]+0.1*G_Strength[nid])*G_CI_value[nid])/float(1+G_c[nid]),3)
...
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Power.csv")
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\karate1.csv")
G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\ModMaTTTTTTTTTT.csv")
...
for results_list in Methods_results_List:
    ...
    G=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\ModMaTTTTTTTTTT.csv")
    largest_cc_list=[]
    H_list=[]
    remove_rate=[]
    #print results_list
