...
##########********************数据存放文件****************
file = open(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\celegans\celegans.txt", "w+")
...
G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Celegans.csv")
...
for results_list in Methods_results_List:
    ...
    G=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Celegans.csv")
    largest_cc_list=[]
    H_list=[]
    remove_rate=[]
    #print results_list
