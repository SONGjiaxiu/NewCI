...
#GenSmallWorld
Rnd = snap.TRnd(1,0)
UGraph = snap.GenSmallWorld(1000,5, 0.3, Rnd)
#UGraph = snap.GenRndGnm(snap.PUNGraph, 200, 500)
file1 = open(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\email\WS_dege1.csv", "w+" )
...
G1=createGraph(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\email\WS_dege1.csv")
BA=G1.copy() 
# print G.degree(0)                                  
# print G.degree()                                    
...
# raw_input()
##########********************数据存放文件****************
file = open(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\email\WS_dege2.csv", "w+")
...
for results_list_id in range(len(Methods_results_List)):
    ...
    G=createGraph(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\email\WS_dege1.csv")
    G=BA
    largest_cc_list=[]
    H_list=[]
    remove_rate=[]
