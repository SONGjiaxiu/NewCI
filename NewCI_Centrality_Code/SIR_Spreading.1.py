...
import operator
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\010\karate.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\009\Celegans.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\003\Email.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\010\jazz.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\010\power.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\010\Router.txt", "w+")
#file = open(r"C:\Users\Administrator\Desktop\3th_result\SIR\55555yuzhi\Yeast.txt", "w+")
...
#Graph = snap.LoadEdgeList(snap.PUNGraph, "C:\Python27\sjxwork\NewCI_Cetrality_Code\dateset_txt\Email.txt", 0, 1)
...
#Graph = snap.LoadEdgeList(snap.PUNGraph, r"C:\Python27\sjxwork\NewCI_Centrality_Code\dateset_txt\Router.txt", 0, 1)
#Graph = snap.LoadEdgeList(snap.PUNGraph, r"C:\Python27\sjxwork\NewCI_Centrality_Code\dateset_txt\Yeast.txt", 0, 1)
