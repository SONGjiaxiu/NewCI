...
csv_data = pd.read_csv(r'C:\Users\Administrator\Desktop\3th_result\SIR_matlab\power0.1-0.55\power.csv')
#print csv_data
sir_node=[]
...
labels = ['0.10','0.15','0.20','0.25','0.30','0.35','0.40','0.45','0.50','0.55']
fig=plt.figure()
...
ax.legend(loc='lower right',bbox_to_anchor=(0.9,0.05),ncol=3,fontsize=7.5,frameon=False)
