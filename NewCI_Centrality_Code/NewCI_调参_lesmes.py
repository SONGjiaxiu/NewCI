...
##########********************数据存放文件****************
file = open(r"C:\Users\Administrator\Desktop\3th_result\mianyitu\email\p2p.txt", "w+")
...
#D:\rengongdata\networks\a.csv
G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Football.csv")
...
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Email.csv")
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\p2p.csv")
#print G_init.edges()
...
for results_list in Methods_results_List:
    ...
    G=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Football.csv")
    #G=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\p2p.csv")
    largest_cc_list=[]
    H_list=[]
    remove_rate=[]
    #print results_list
...
ax1.plot(np.array(remove_rate,dtype=float) ,np.array(max_connected_component['newci91'],dtype=float)/float(G_init.number_of_nodes()),'y-',label='NewCI_B/R')
