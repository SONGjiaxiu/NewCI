...
def New_Collective_Influence(G):
    ...
    for nid in G_CI_value.keys():
        ...
        #newCI[nid]=round(float(0.9*G_Balance[nid]/float(1+G_c[nid])*G_CI_value[nid]+0.1*G_Strength[nid]*G_CI_value[nid]),3)
...
csv_data = pd.read_csv(r'C:\Users\Administrator\Desktop\3th_result\SIR_matlab\ModMaT\ModMaT18.csv')
#print csv_data
sir_node=[]
