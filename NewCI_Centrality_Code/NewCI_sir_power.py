...
from SIR_data_power import data009
...
for i in id_degree:
    #print type(i)
    yingxiangli_value_degree.append(data009[int(i)])
...
for i in id_between:
    ...
    yingxiangli_value_between.append(data009[int(i)])
...
for i in id_closeness:
    # print sir_email[int(i)]
    yingxiangli_value_closeness.append(data009[int(i)])
...
for i in id_pagerank:
    # print sir_email[int(i)]
    yingxiangli_value_pagerank.append(data009[int(i)])
...
for i in id_kcore:
    # print sir_email[int(i)]
    yingxiangli_value_kcore.append(data009[int(i)])
...
for i in id_CI:
    # print sir_email[int(i)]
    yingxiangli_value_CI.append(data009[int(i)])
...
for i in id_NewCI:
    # print sir_email[int(i)]
    yingxiangli_value_NewCI.append(data009[int(i)])
