...
G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\literature_1976TTTTTTTTTTTT.csv")
...
csv_data = pd.read_csv(r'C:\Users\Administrator\Desktop\3th_result\SIR_matlab\literature_1976\literature_1976(0.1-0.28).csv')
#print csv_data
sir_node=[]
...
labels = ['0.1','0.12','0.14','0.16','0.18','0.20','0.22','0.24','0.26','0.28']
fig=plt.figure()
