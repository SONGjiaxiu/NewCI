...
for i in id_degree:
    ...
    yingxiangli_value_degree.append(sir_email005[int(i)])
...
for i in id_between:
    # print sir_email[int(i)]
    yingxiangli_value_between.append(sir_email005[int(i)])
...
for i in id_closeness:
    # print sir_email[int(i)]
    yingxiangli_value_closeness.append(sir_email005[int(i)])
...
for i in id_pagerank:
    # print sir_email[int(i)]
    yingxiangli_value_pagerank.append(sir_email005[int(i)])
...
for i in id_kcore:
    # print sir_email[int(i)]
    yingxiangli_value_kcore.append(sir_email005[int(i)])
...
for i in id_CI:
    # print sir_email[int(i)]
    yingxiangli_value_CI.append(sir_email005[int(i)])
...
for i in id_NewCI:
    # print sir_email[int(i)]
    yingxiangli_value_NewCI.append(sir_email005[int(i)])
