...
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\Power.csv")
#G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\karate1.csv")
G_init=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\koeal2TTTTTTT.csv")
...
for results_list in Methods_results_List:
    ...
    G=createGraph(r"C:\Python27\sjxwork\NewCI_Centrality_Code\Dataset_csv\koeal2TTTTTTT.csv")
    largest_cc_list=[]
    H_list=[]
    remove_rate=[]
    #print results_list
